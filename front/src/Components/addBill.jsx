    ...
    const renderCart = () => {
        if (cart.length > 0) {
            return cart.map(item => (
                <tr key={item.id} className="allBill_cart_row">
                    <td className="allBill_cart_data">{item.productName}</td>
                    <td className="allBill_cart_data">{item.productQuantity}</td>
                    <td className="allBill_cart_data">{Number(item.price).toFixed(2)}</td>
                    <td className="allBill_cart_data">{item.unit}</td>
                    <td className="allBill_cart_data">{Number(item.totalPrice).toFixed(2)}</td>
                </tr>
            ))
        } else {
            return (
                <tr className="allBill_cart_row">
                    <td className="allBill_cart_message">No items in the cart</td>
                </tr>
            )
        }
    }
                ...
                <div className="addBill_main">
                    <div className="addBill_body">
                        ...
                        <table className="addBill_table">
                            <thead>
                                <tr className="allBill_cart_row">
                                    <th className="allBill_cart_head">Name</th>
                                    <th className="allBill_cart_head">Quantity</th>
                                    <th className="allBill_cart_head">Price</th>
                                    <th className="allBill_cart_head">Unit</th>
                                    <th className="allBill_cart_head">Total Price</th>
                                </tr>
                            </thead>
                            <tbody>
                                {renderCart()}
